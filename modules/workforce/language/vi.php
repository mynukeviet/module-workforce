...
$lang_module['feedback'] = 'Gửi góp ý';
...
$lang_module['send_feedback'] = 'Gửi góp ý';
$lang_module['add'] = 'Thêm mới';
$lang_module['edit'] = 'Sửa';
$lang_module['delete'] = 'Xóa';
$lang_module['number'] = 'STT';
...
$lang_module['error_required_feedback'] = 'Lỗi: bạn cần nhập dữ liệu cho nội dung';
$lang_module['error_required_title'] = 'Lỗi: bạn cần nhập dữ liệu cho tiêu đề';
$lang_module['success_input'] = 'Thư góp ý của bạn đã được chuyển tới %s. Xin cảm ơn!';
$lang_module['error_empty_mail'] = 'Hệ thống không tìm thấy email, vui lòng kiểm tra lại thông tin';
